...
class Booking(models.Model):
    ...
    Attributes:
        ...
        phone_number (CharField): The contact phone number of
...
def create_booking(user, date, time, guests, your_name, email, tables):
    ...
    booking = Booking.objects.create(
        ...
        guests=guests, your_name=your_name, email=email
    )
    for table in tables:
...
class MenuItem(models.Model):
    ...
    Attributes:
        ...
        category (CharField): The category of
        the menu item (e.g., starters, pizza, pasta).
    ...
    category = models.CharField(
        max_length=2, choices=CATEGORY_CHOICES, default='ST')
    image = CloudinaryField(
        'image',
        default='https://res.cloudinary.com/dpwp5cavi/image/upload/v1687277051/menu_pic_q2kjau.jpg'
    )
